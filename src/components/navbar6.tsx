...
const ITEMS: Array<{
...
}> = [
  {
    ...
    href: "/products",
    dropdownItems: [
      { title: "Raw Materials", href: "/products/raw-jute", description: "Raw jute, jute sliver, and cut jute fiber in multiple grades." },
      { title: "Yarn", href: "/products/jute-yarn", description: "Single and multi-ply jute yarn, 8–96 lbs count, natural or dyed." },
      { title: "Fabrics & Cloth", href: "/products/hessian-cloth", description: "Hessian and sacking cloth, 24–52 inch widths, 200–305 GSM." },
      { title: "Bags & Packaging", href: "/products/jute-bag", description: "Hessian bags, sacking sacks, and custom jute bags for bulk goods." },
      { title: "Rope & Twine", href: "/products/jute-rope", description: "Jute rope 6–42 mm and twine for packaging, tying, and gardening." },
    ],
  },
